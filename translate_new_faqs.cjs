...
const translations = {
    "hindi": [
        ...
        { q: "मैं किसी बग या समस्या की रिपोर्ट कैसे करूं?", a: "यदि आपको कोई समस्या आती है, तो कृपया 'हमसे संपर्क करें' फ़ॉर्म का उपयोग करें या हमारी सहायता टीम को सीधे support@a-series.in पर ईमेल करें।" }
    ],
    "bengali": [
        ...
        { q: "আমি কীভাবে কোনো বাগ বা সমস্যার রিপোর্ট করব?", a: "আপনি যদি কোনো সমস্যার সম্মুখীন হন, অনুগ্রহ করে 'আমাদের সাথে যোগাযোগ করুন' ফর্মটি ব্যবহার করুন বা আমাদের সহায়তা দলকে সরাসরি support@a-series.in এ ইমেল করুন।" }
    ],
    "tamil": [
        ...
        { q: "பிழை அல்லது சிக்கலைப் புகாரளிப்பது எப்படி?", a: "நீங்கள் ஏதேனும் சிக்கல்களைச் சந்தித்தால், 'எங்களைத் தொடர்பு கொள்ளுங்கள்' படிவத்தைப் பயன்படுத்தவும் அல்லது support@a-series.in இல் எங்கள் ஆதரவுக் குழுவிற்கு நேரடியாக மின்னஞ்சல் செய்யவும்." }
    ],
    "telugu": [
        ...
        { q: "నేను బగ్ లేదా సమస్యను ఎలా నివేదించాలి?", a: "మీరు ఏవైనా సమస్యలను ఎదుర్కొంటే, దయచేసి 'మమ్మల్ని సంప్రదించండి' ఫారమ్‌ను ఉపయోగించండి లేదా మా మద్దతు బృందానికి నేరుగా support@a-series.in లో ఇమెయిల్ చేయండి." }
    ],
    "marathi": [
        ...
        { q: "मी बग किंवा समस्येची तक्रार कशी करू?", a: "तुम्हाला काही समस्या आल्यास, कृपया 'संपर्क साधा' फॉर्म वापरा किंवा आमच्या सपोर्ट टीमला थेट support@a-series.in वर ईमेल करा." }
    ],
    "gujarati": [
        ...
        { q: "હું ભૂલ અથવા સમસ્યાની જાણ કેવી રીતે કરી શકું?", a: "જો તમને કોઈ સમસ્યા આવે, તો કૃપા કરીને 'અમારો સંપર્ક કરો' ફોર્મનો ઉપયોગ કરો અથવા અમારી સપોર્ટ ટીમનો સીધો support@a-series.in પર સંપર્ક કરો." }
    ],
    "french": [
        ...
        { q: "Comment signaler un bug ou un problème ?", a: "Si vous rencontrez des problèmes, veuillez utiliser le formulaire « Contactez-nous » ou envoyer un e-mail directement à notre équipe d'assistance à support@a-series.in." }
    ],
    "spanish": [
        ...
        { q: "¿Cómo informo un error o problema?", a: "Si encuentra algún problema, utilice el formulario 'Contáctenos' o envíe un correo electrónico a nuestro equipo de soporte directamente a support@a-series.in." }
    ],
    "arabic": [
        ...
        { q: "كيف يمكنني الإبلاغ عن خطأ أو مشكلة؟", a: "إذا واجهت أي مشاكل، يرجى استخدام نموذج 'اتصل بنا' أو إرسال بريد إلكتروني إلى فريق الدعم لدينا مباشرة على support@a-series.in." }
    ]
};
